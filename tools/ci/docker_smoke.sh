...
# Substitute: gridlock, coworld-gridlock, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-gridlock:ci)
#   SMOKE_SLUG                 game slug                        (gridlock)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/gridlock)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/gridlock-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-gridlock:ci}}"
slug="${SMOKE_SLUG:-gridlock}"
